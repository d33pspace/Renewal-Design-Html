...
const easing = { 
  ...
  class IosSelector { 
	...
	//   this.itemHeight = this.elems.el.offsetHeight * 7 / this.options.count; // 每项高度 
	  this.itemHeight = 60; // 每项高度 
  ...
  $( document ).ready(function() {
	var inputBox = document.getElementById("input-birthday");
	...
	function pushValToInput(){
	  var selectedDate =
		String(yearSelector.value) + "-" +
		String(monthSelector.value) + "-" +
		String(daySelector.value);
	  
	  inputBox.value = selectedDate;
	}
  });
